...
*/
$current_url = !empty($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : $_SERVER['SERVER_ADDR'];
return array (
    //系统网址
    'SITE_URL' => 'http://'.$current_url,
    //数据库配置
    'DB_TYPE'   => 'mysql',
    'DB_HOST'   => "127.0.0.1",
    'DB_PORT'   => 3306,
    ...
    'COOKIE_DOMAIN' => '',
    'COOKIE_PATH' => '/',
    'ECM_KEY' => '13473df829cd5929e42abde1f5f5a54c',
    'MALL_SITE_ID' => 'EMQDLPstc5We1e7h',
    'ENABLED_GZIP' => 0,
    'DEBUG_MODE' => 0,
